...
class addDespesaemp extends StatefulWidget {
  ...
  @override
  State<addDespesaemp> createState() => _addDespesaempState();
}

class _addDespesaempState extends State<addDespesaemp> {
 ...
 Future selectDespesa()async{
  ...
  Future novaDespesa()async {
    ...
    var resultado =  await conn.execute("Insert into rendaemp(ID_Usuario, Usuario, Origem, Valor, Categoria, Tipo) VALUES (:ID_Usuario, :Usuario, :Origem, :Valor, :Categoria, :Tipo)", parametros);
