...
class Addrendaprojecaoemp extends StatefulWidget {

  final int? IDU;
  const Addrendaprojecaoemp({
    super.key,
    required this.IDU,});

  @override
  State<Addrendaprojecaoemp> createState() => _AddrendaprojecaoempState();
}

class _AddrendaprojecaoempState extends State<Addrendaprojecaoemp> {
 ...
 Future selectDespesa()async{
  ...
  Future novaDespesa()async {
    ...
    var resultado =  await conn.execute("Insert into projeçãoemp(ID_Usuario, Usuario, Origem, Valor, Categoria, Tipo) VALUES (:ID_Usuario, :Usuario, :Origem, :Valor, :Categoria, :Tipo)", parametros);
  }
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        title: Text('Adicionar Projeção Renda'),
        centerTitle: true,
