...
class addRenda extends StatefulWidget {
  ...
  @override
  State<addRenda> createState() => _addRendaState();
}

class _addRendaState extends State<addRenda> {
 ...
 Future selectRenda()async{
  ...
  Future novaRenda()async {
    ...
    var resultado =  await conn.execute("Insert into rendap(ID_Usuario, Usuario, Origem, Valor, Categoria, Tipo) VALUES (:ID_Usuario, :Usuario, :Origem, :Valor, :Categoria, :Tipo)", parametros);
