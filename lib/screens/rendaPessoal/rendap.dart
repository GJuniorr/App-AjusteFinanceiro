...
class renda extends StatefulWidget {
  ...
  @override
  State<renda> createState() => _rendaState();
}
...
class _rendaState extends State<renda> {
  ...
  Future selectRenda() async {
       var resultadoSR = await conn.execute("Select * from rendap WHERE ID_Usuario = '$IDU' ");
      ...
      if (count > 0) {
        ...
        Map data = element.assoc();
        rendaID = int.tryParse(data['ID_RendaP']);
    ...
    var resultadoDadosG = await conn.execute("SELECT * FROM rendap WHERE ID_Usuario = '$IDU' ORDER BY Categoria DESC");
    List<Map<String, String>> listG = [];

    for (final row in resultadoDadosG.rows) {
      final dataG = {
        'ID_RendaP': row.colAt(0)!,
    ...
    var resultadoDadosADDRenda = await conn.execute("SELECT * FROM rendap WHERE ID_Usuario = '$IDU' AND Tipo = 'Renda+do mês'  ORDER BY Valor DESC"); 
    ...
    var resultadoDadosRendaMensal = await conn.execute("SELECT * FROM rendap WHERE ID_Usuario = '$IDU' AND Tipo = 'Renda Mensal'  ORDER BY Valor DESC");
    ...
    var resultadoDadosADDRendaM = await conn.execute("SELECT * FROM rendap WHERE ID_Usuario = '$IDU' AND Categoria = 'Renda'  ORDER BY Valor DESC");
    ...
    var resultadoDadosADDDespesa = await conn.execute("SELECT * FROM rendap WHERE ID_Usuario = '$IDU' AND Tipo = 'Despesa+do mês'  ORDER BY Valor DESC");
    ...
    var resultadoDadosDespesaM = await conn.execute("SELECT * FROM rendap WHERE ID_Usuario = '$IDU' AND Tipo = 'Despesa Mensal'  ORDER BY Valor DESC");
    ...
    var resultadoDadosADDDespesaM = await conn.execute("SELECT * FROM rendap WHERE ID_Usuario = '$IDU' AND Categoria = 'Despesa'  ORDER BY Valor DESC");
  ...
  Future removerItem(int rendaID)async {
      ...
      "DELETE FROM rendap WHERE ID_RendaP = :ID_RendaP ",
      {
        'ID_RendaP': rendaID,
      },
    );
                          ...
                          Row(
                            ...
                            children: [
                              TextButton(
                                ...
                                onPressed: () async {
                                  Navigator.of(context).pop();
                                    await removerItem(int.parse(dadosRendaADD[index]['ID_RendaP']!));
                                }, child: Text('Apagar'),
                                ),
                            ],
                          )
                          ...
                          Row(
                            ...
                            children: [
                              TextButton(
                                ...
                                onPressed: () async {
                                  Navigator.of(context).pop();
                                   await removerItem(int.parse(dadosRendaM[index]['ID_RendaP']!));
                                }, child: Text('Apagar'),
                                ),
                            ],
                          )
                          ...
                          Row(
                            ...
                            children: [
                              TextButton(
                                ...
                                onPressed: () async {
                                  Navigator.of(context).pop();
                                   await removerItem(int.parse(dadosRendaADDM[index]['ID_RendaP']!));
                                }, child: Text('Apagar'),
                                ),
                            ],
                          )
                          ...
                          Row(
                            ...
                            children: [
                              TextButton(
                                ...
                                onPressed: () async {
                                  Navigator.of(context).pop();
                                   await removerItem(int.parse(dadosDespesaADD[index]['ID_RendaP']!));
                                }, child: Text('Apagar'),
                                ),
                            ],
                          )
                          ...
                          Row(
                            ...
                            children: [
                              TextButton(
                                ...
                                onPressed: () async {
                                  Navigator.of(context).pop();
                                  await removerItem(int.parse(dadosDespesaM[index]['ID_RendaP']!));
                                }, child: Text('Apagar'),
                                ),
                            ],
                          )
                          ...
                          Row(
                            ...
                            children: [
                              TextButton(
                                ...
                                onPressed: () async {
                                  Navigator.of(context).pop();
                                  await removerItem(int.parse(dadosDespesaADDM[index]['ID_RendaP']!));
                                }, child: Text('Apagar'),
                                ),
                            ],
                          )
                          ...
                          Row(
                            children: [
                               IconButton(
                                onPressed: () {
                                  Navigator.push(context, 
                                  MaterialPageRoute(builder: (context) => addRenda(
                                    IDU: IDU
                                  )));
                                }, icon: Icon(Icons.add,
                                color: Colors.black,)),
                              ...
                              Padding(
                                ...
                                onPressed: () {
                                   Navigator.push(context, 
                                  MaterialPageRoute(builder: (context) => addDespesa(
                                    IDU: IDU
                                  )));
                                }, icon: Icon(Icons.add,
                                color: Colors.black,))
